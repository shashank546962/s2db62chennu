...
router.get('/', function(req, res) {
  res.render('index', { title: 'sweetmagic App', user:req.user });
});

router.get('/register', function(req, res) {
  res.render('register', { title: 'sweetmagic App Registration'});
  });
...
router.get('/login', function(req, res) {
  res.render('login', { title: 'sweetmagic App Login', user : req.user });
});
